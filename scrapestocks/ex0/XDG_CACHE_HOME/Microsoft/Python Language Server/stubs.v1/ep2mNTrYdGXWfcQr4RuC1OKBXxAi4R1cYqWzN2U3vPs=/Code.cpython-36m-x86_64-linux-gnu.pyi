...
import Cython.StringIOTree as _mod_Cython_StringIOTree
...
class CCodeWriter(_mod_builtins.object):
    ...
    def put_add_traceback(self, qualified_name, include_cline):
...
class FunctionState(_mod_builtins.object):
    ...
    __dict__ = {}
    def __init__(self, owner, names_taken, scope):
        pass
...
class LazyUtilityCode(UtilityCodeBase):
    ...
    def load_cached(self, cls, utility_code_name, from_file, _UtilityCodeBase__cache):
...
SourceDescriptor = _mod_Cython_Compiler_Scanning.SourceDescriptor
...
StringIOTree = _mod_Cython_StringIOTree.StringIOTree
class TempitaUtilityCode(UtilityCode):
    ...
    def load_cached(self, cls, utility_code_name, from_file, context, _TempitaUtilityCode__cache):
        pass
...
__builtins__ = {}
__cached__ = '/usr/lib/python3/dist-packages/Cython/Compiler/__pycache__/Code.cpython-37.pyc'
__doc__ = None
__file__ = '/usr/lib/python3/dist-packages/Cython/Compiler/Code.py'
...
def find_alphanums(self, string, pos, endpos):
...
def modifier_output_mapper(self, key, default):
    'Return the value for key if key is in the dictionary, else default.'
    pass

non_portable_builtins_map = _mod_builtins.dict()
partial = _mod_functools.partial
def possible_bytes_identifier(self, string, pos, endpos):
    'Matches zero or more characters at the beginning of the string.'
    pass

def possible_unicode_identifier(self, string, pos, endpos):
    'Matches zero or more characters at the beginning of the string.'
    pass

def replace_identifier(self, repl, string, count):
